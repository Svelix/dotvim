...
hi Folded		term=standout  ctermbg=Black ctermfg=Gray  gui=bold guifg=LightCyan guibg=Black
" From the source:
...
hi StatusLine	term=reverse,bold cterm=reverse   gui=bold		guifg=Black guibg=DarkGreen
hi StatusLineNC term=reverse   cterm=reverse	  gui=NONE		guifg=Black guibg=LightGreen
